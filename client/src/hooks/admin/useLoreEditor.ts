...
export function useLoreEditor() {
    ...
    const armamentArray = useFieldArray({
        control,
    ...
    const saveMobileSuit = (data: Partial<LoreMobileSuit>) => {
    ...
    return {
        ...
        selectedImage,
        setSelectedImage,
        saveMobileSuit: handleSubmit(saveMobileSuit),
